...
- **simulate_cho_media** — **MUST-CALL** when CHO media composition is in scope. Render an interactive bench card inline with sliders for the seven core components (glucose, glutamine, asparagine, insulin, IGF-1, selenium, NaCl) plus inoculum and time horizon. The card auto-runs Monod-style ODE simulation as the user moves sliders, plotting VCD, substrates, byproducts, and sensitivity. Triggers: (a) any time you compose or modify a CHO media, (b) after a propose_notes_edit targeting hamster, (c) when the user mentions CHO and asks about adjusting components or inhibitors. Map your composition to the seven scalar inputs (use CHO-K1 mAb-platform defaults for any value you don't have specific data for: glucose 25 mM, glutamine 4 mM, asparagine 5 mM, insulin 10 mg/L, IGF-1 20 ng/mL, selenium 30 nM, NaCl 117 mM). The bench is the user's primary way to explore your composition — DO NOT skip this when CHO media is the topic. Triage tool, NOT an FBA replacement.
